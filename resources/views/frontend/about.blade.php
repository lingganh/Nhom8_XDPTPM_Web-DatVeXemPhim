...
@section('content')
    <div class="container py-5 max-w-lg mx-auto"> <!-- Thay max-w-3xl thành max-w-lg để thu nhỏ khung -->
        <div class="bg-white shadow-lg rounded-2xl p-6 text-black"> <!-- Giảm padding từ p-8 xuống p-6 -->
            <h1 class="text-4xl font-bold text-center mb-6">Về chúng tôi</h1>

            <div class="space-y-4 indent-8 leading-relaxed text-lg">
                <p>
            ...
            <p class="text-xl font-semibold text-center mt-6">
