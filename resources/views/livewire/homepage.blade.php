                ...
                <div class="headerhny-title">
                    <div class="w3l-title-grids">
                        ...
                        <div class="headerhny-right text-lg-right">
                            <h4><a class="show-title" href="{{route('user.movieIndex',['trangThai' => 'Đang chiếu'])}}" >Tất cả chương trình</a></h4>
                        </div>
                    </div>
                </div>
                                ...
                                <a href="{{ route('film.index') }}">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <div class="movie-buttons">
                                            ...
                                            <a href="{{ route('client.movies.show', ['M_id' => $phim->M_id]) }}" class="btn btn-danger">Đặt Vé </a>
            ...
            <div class="container py-lg-3">
                <div class="headerhny-title">
                    <div class="w3l-title-grids">
                        ...
                        <div class="headerhny-right text-lg-right">
                            <h4><a class="show-title" href="{{route('user.movieIndex',['trangThai' => 'Sắp chiếu'])}}">Tất cả chương trình</a></h4>
                        </div>
                    </div>
                </div>
                <div class="w3l-populohny-grids">
                            ...
                            <div class="box16">
                                <a href="{{ route('film.index') }}">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <div class="movie-buttons">
                                            <a href="{{ route('client.movies.show', ['M_id' => $phim->M_id]) }}" class="btn btn-info">Xem Chi Tiết </a>
