                                    ...
                                    <a href="{{ route('film.index') }}">
                                        ...
                                        <span class="post">
                                            ...
                                            <div class="movie-buttons">
                                                ...
                                                <a href="{{ route('client.movies.show', ['M_id' => $phim->M_id]) }}" class="button btn-primary">Đặt Vé </a>
                                ...
                                <a href="{{ route('film.index') }}">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <span class="post">
                                         ...
                                         <div class="movie-buttons">
                                            <a href="{{ route('client.movies.show', ['M_id' => $phim->M_id]) }}" class="button btn-primary">Xem Chi Tiết </a>
