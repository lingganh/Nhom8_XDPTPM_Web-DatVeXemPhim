            ...
            <div class="w3l-populohny-grids">
                <div class="item vhny-grid">
                    <div class="box16">
                        <a href="movies.html">
                            <figure>
                                <img class="img-fluid" src="frontend/assets/images/wednesday.jpeg" alt="">
                            </figure>
                ...
                <div class="item vhny-grid">
                    <div class="box16">
                        <a href="movies.html">
                            <figure>
                                <img class="img-fluid" src="frontend/assets/images/commando2.jpeg" alt="">
                            </figure>
                            <div class="box-content">
                ...
                <div class="item vhny-grid">
                    <div class="box16">
                        <a href="movies.html">
                            <figure>
                                <img class="img-fluid" src="frontend/assets/images/gujju2.jpeg" alt="">
                            </figure>
                            <div class="box-content">
                ...
                <div class="item vhny-grid">
                    <div class="box16">
                        <a href="movies.html">
                            <figure>
                                <img class="img-fluid" src="frontend/assets/images/avtar-2.jpeg" alt="">
                            </figure>
                            <div class="box-content">
    ...
    <div class="grids-main py-5">
        <div class="container py-lg-3">
            <div class="headerhny-title">
                <div class="w3l-title-grids">
                    <div class="headerhny-left">
                        <h3 class="hny-title">Bản phát hành mới nhất </h3>
                    </div>
                    <div class="headerhny-right text-lg-right">
            ...
            <div class="owl-three owl-carousel owl-theme">
                <div class="item vhny-grid">
                    <div class="box16 mb-0">
                        <a href="movies.html">
                            <figure>
                                <img class="img-fluid" src="frontend/assets/images/n1.jpg" alt="">
                            </figure>
                            <div class="box-content">
                ...
                <div class="item vhny-grid">
                    <div class="box16 mb-0">
                        <a href="movies.html">
                            <figure>
                                <img class="img-fluid" src="frontend/assets/images/n2.jpg" alt="">
                            </figure>
                            <div class="box-content">
                ...
                <div class="item vhny-grid">
                    <div class="box16 mb-0">
                        <a href="movies.html">
                            <figure>
                                <img class="img-fluid" src="frontend/assets/images/n3.jpg" alt="">
                            </figure>
                            <div class="box-content">
                ...
                <div class="item vhny-grid">
                    <div class="box16 mb-0">
                        <a href="movies.html">
                            <figure>
                                <img class="img-fluid" src="frontend/assets/images/n4.jpg" alt="">
                            </figure>
                            <div class="box-content">
                ...
                <div class="item vhny-grid">
                    <div class="box16 mb-0">
                        <a href="movies.html">
                            <figure>
                                <img class="img-fluid" src="frontend/assets/images/n5.jpg" alt="">
                            </figure>
                            <div class="box-content">
                ...
                <div class="item vhny-grid">
                    <div class="box16 mb-0">
                        <a href="movies.html">
                            <figure>
                                <img class="img-fluid" src="frontend/assets/images/n6.jpg" alt="">
                            </figure>
                            <div class="box-content">
