        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="ibox">
                <div class="ibox-title">
                    <a href="{{ route('backend.moviveShowtime.create') }}" class="btn btn-primary"> Tạo lịch chiếu</a>
                    <a href="{{ route('backend.moviveShowtime.index') }}" class="btn btn-info">Refresh</a>
                </div>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        @foreach($lichchieu as $lich)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('backend.moviveShowtime.edit', $lich->idLC) }}" class="btn btn-sm btn-primary">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <form action="{{ route('backend.moviveShowtime.destroy', $lich->idLC) }}" method="POST" style="display:inline;" onsubmit="return confirm('Bạn có chắc chắn muốn xoá lịch chiếu này không?');">
                                        @csrf
                                        @method('DELETE')
